...
class StateManagerTest {
    ...
    void loadConfiguration() {
        ...
        stateManager.loadConfiguration("D:\\Progetti\\Scienza\\turing-machine\\src\\test\\java\\configurations\\conf1.json");
    ...
    void oneStep() {
        ...
        assertEquals(List.of('R', 'R', 'S', 'S'), transitionOutput.memoryMoves());
        assertEquals('a', transitionOutput.outputChar_outputTape());
        ...
        assertEquals(List.of('$', '$'), transitionOutput.memoryOutput());
        assertEquals(List.of('R', 'R', 'S', 'S'), transitionOutput.memoryMoves());
        assertEquals('b', transitionOutput.outputChar_outputTape());
        assertFalse(transitionOutput.isMachineBlocked());
